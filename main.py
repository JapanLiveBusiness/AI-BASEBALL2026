...
.brand{{display:flex;gap:11px;align-items:center;text-decoration:none;color:inherit}}.brand:hover b{{color:#ffd45a}}.logo{{width:40px;height:40px;border:2px solid #efb82e;border-radius:50%;display:grid;place-items:center;color:#efb82e;font-size:17px}}.brand b{{display:block;color:#efb82e;font-size:17px}}.brand small{{font-size:8px;color:#9ca4ad}}
...
<div class="dash">
<div class="top"><a class="brand" href="/" aria-label="トップページへ戻る"><div class="logo">⚾</div><div><b>AI BASEBALL STUDIO</b><small>AI野球分析・シミュレーション研究所</small></div></a><nav class="nav"><a href="/"><i>⌂</i>ダッシュボード</a><a href="/試合"><i>▦</i>試合一覧</a><a href="/本日のAI予想"><i>▣</i>AIランキング</a><a href="/BET入力"><i>↗</i>シミュレーション</a><a href="/収支マップ"><i>◉</i>分析結果</a><a href="/予想結果"><i>◷</i>履歴</a><a href="/設定"><i>⚙</i>設定</a></nav><div class="mode">リサーチモード<small>研究・仮説検証用</small></div></div>
