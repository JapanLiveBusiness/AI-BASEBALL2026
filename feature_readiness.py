...
FEATURES = (
    ...
    Feature("bet_entry", "BET入力", "/BET入力", "beta", "BETの新規登録に対応", "登録済みBETの編集・削除・未確定から確定への更新"),
    Feature("performance", "収支マップ", "/収支マップ", "beta", "確定BETの収支・的中率・ROIを表示", "重複するBET入力処理の共通化と未確定BETの精算導線"),
