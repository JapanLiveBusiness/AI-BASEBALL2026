...
_premium_opp_logo = npb_logo_slug(_premium_opponent)
...
if total == 0:
    ...
    if hawks_pct is not None and opp_pct is not None:
        base_prob = bradley_terry_probability(hawks_pct, opp_pct)
    ...
    final_sb = clamp_probability(total_raw)
